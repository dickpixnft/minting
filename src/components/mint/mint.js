            ...
            <Container>
                <Row>
                    ...
                    <Col md={6} xs={12} className='mint-description'>
                        <header>MINT YOUR <text style={{ color: "white" }}>DICK PIX</text>
                            <br /> BAG OF DICKS <text style={{ color: "white" }}>COLLECTION GAME:</text>
                        </header>
                        <p style={{ textAlign: "center" }}>

                            777 images are original to the collection. 
                            Images #778-#3000 are individually rendered 
                            in B&W, Gold, and 3D versions, to create a 
                            card trading game called BAG OF DICKS. The 
                            more complete series you collect, the bigger 
                            your “bag of dicks" becomes. Think of it as a 
                            game of "Go Fish" but with dicks and airdrops.
                            <br/><br/>
                            Show us your dicks on
